...
from Aulas.APIs.FastAPI.Desafio.atleta.schemas import AtletaIn, AtletaOut, AtletaUpdate
...
async def post(
    ...
    try:
        atleta_out = AtletaOut(id = uuid4(), created_at= datetime.timezone.utc(), **atleta_in.model_dump())
